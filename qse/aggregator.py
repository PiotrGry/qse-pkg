"""
Universal QSE_total aggregation with proper bounds and weight constraints.
...
METRIC_NAMES = ["richness", "compliance", "coupling", "complexity", "risk"]
...
def compute_qse_total(metrics: SubMetrics,
    ...
    All sub-metrics are already in [0, 1].
    """
    if weights is None:

...
**Repository:** `sample-ai-drift-demo (cycle_new overlay applied)`  
**Generated:** 2026-04-19T19:23:06+00:00  
**Scan:** 10 modules, 10 dependencies

## Executive summary

- **Health score:** **0.0/100** (🔴 Severe drift)
...
|---|---|---|---|---|
| **P1** | 100 | `src.domain.order` | CYCLE_NEW, LAYER_VIOLATION | Participates in a cycle; also flagged by CYCLE_NEW, LAYER_VIOLATION. |
| **P1** | 100 | `src.application.order_service` | CYCLE_NEW, LAYER_VIOLATION | Participates in a cycle; also flagged by CYCLE_NEW, LAYER_VIOLATION. |

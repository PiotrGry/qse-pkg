...
**Java GT** (stan kwiecień 2026, po wykluczeniach E13d):
- n = 59 (27 POS, 28 NEG, 4 EXCL)
- Mann-Whitney p = 0.00157 (AGQ v3c, post-exclusion)
- Spearman ρ = 0.380
- AUC-ROC = 0.733
- Partial r = 0.308

> **Uwaga**: Wcześniejsze statystyki (31 POS, 28 NEG, p=0.000221, AUC=0.767) pochodzą z fazy pre-exclusion.
> Po E13d wykluczono 4 repozytoria z panelem 4.0–5.75 (UNCLEAR), co obniżyło metryki ale poprawiło rzetelność GT.
...
5. **8× przeszacowanie efektu** — w E13g (Pilot 3, newbee-mall) panel ekspertów przypisał refaktoryzacji zmianę ≈+2.5 pkt, podczas gdy AGQ zmierzył Δ=+0.31. Panel systematycznie przeszacowuje wpływ refaktoryzacji na jakość architektoniczną ~8× (por. [[Limitations]]).

#!/usr/bin/env python3
"""E13f: QSE-Track pilot on Apache Commons Collections — full scan/fix/measure cycle.

Scans apache/commons-collections with QSE three-layer framework,
performs aggressive refactoring to break package cycles, rescans, and compares.

Target repo: https://github.com/apache/commons-collections
Baseline problems:
  - 16/20 packages in a single giant SCC
  - PCA = 0.1111
  - SH = 0.3333
"""
...
REPO_PATH = "/home/user/workspace/commons-collections/src/main/java"
...
if __name__ == "__main__":
    ...
    # Save baseline
    output = {
        "experiment": "E13f_commons_collections_pilot",
    ...
    out_path = ARTIFACTS / "e13f_commons_pilot.json"
